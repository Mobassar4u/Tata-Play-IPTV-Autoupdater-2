...
{
    check_repo=$(curl -i -s -H "Authorization: token $git_token"     https://api.github.com/user/repos | grep 'Tata-Play-IPTV-Daily-Workflow-2') || true
...
ask_user_to_select()
{
    printf "\n Repo named 'Tata-Play-IPTV-Daily-Workflow-2' already exists, What would you like to perform? \n\n"
...
{
    if [[ $selection == '1' ]]; then
    dir=$(curl -s "https://$git_token@raw.githubusercontent.com/$git_id/Tata-Play-IPTV-Daily-Workflow-2/main/.github/workflows/Tata-Play-IPTV-Daily-Workflow-2.yml" | grep 'gist' | sed 's/.*\///g')
...
create_gist()
{
    ...
    gh repo create Tata-Play-IPTV-Daily-Workflow-2 --private -y >> /dev/null 2>&1 || true
    fi
}
...
main()
{
    ...
    cat $LOCALDIR/dependencies/Tata-Play-IPTV-Daily-Workflow-2.yml | envsubst > Tata-Play-IPTV-Daily-Workflow-2.yml
    cd ../..
    ...
    git remote add origin "https://$git_token@github.com/$git_id/Tata-Play-IPTV-Daily-Workflow-2.git"
    dynamic_push;
    ...
    save_creds;
    tput setaf 51; echo "Successfully created your new private repo." && printf "Check your new private repo here: ${NC}https://github.com/$git_id/Tata-Play-IPTV-Daily-Workflow-2\n" && tput setaf 51; printf "Check Your Playlist URL here: ${NC}https://gist.githubusercontent.com/$git_id/$dir/raw/TataPlayPlaylist.m3u \n"
    if [[ "$selection" == '2' ]]; then tput setaf 51; echo -e "Check your other playlist branch here: ${NC}https://github.com/$git_id/Tata-Play-IPTV-Daily-Workflow-2/tree/$dir"; fi
